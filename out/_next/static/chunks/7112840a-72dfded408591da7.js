"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[16],{19:function(e,t,r){r.d(t,{ET:function(){return sm},IO:function(){return i6},JU:function(){return iD},Jm:function(){return iM},PL:function(){return sc},QT:function(){return su},ad:function(){return ix},ar:function(){return i7},hJ:function(){return ib},oe:function(){return sf},r7:function(){return sd}});var n,i,s=r(5816),a=r(8463),o=r(3333),l=r(4444),u=r(6640),h=r(3454);let c="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iO{constructor(...e){for(let t=0;t<e.length;++t)if(0===e[t].length)throw new T(E.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new q(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}function iM(){return new iO("__name__")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function su(e){e=iE(e,iC);let t=iE(e.firestore,ik);return(function(e,t,r={}){let n=new I;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,i){let s=new io({next:s=>{t.enqueueAndForget(()=>nU(e,a));let o=s.docs.has(r);!o&&s.fromCache?i.reject(new T(E.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&n&&"server"===n.source?i.reject(new T(E.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new nz(new e7(r.path),s,{includeMetadataChanges:!0,Z_:!0});return nP(e,a)})(await im(e),e.asyncQueue,t,r,n)),n.promise})(iR(t),e._key).then(r=>(function(e,t,r){let n=r.docs.get(t._key),i=new sh(e);return new sa(e,i,t._key,n,new ss(r.hasPendingWrites,r.fromCache),t.converter)})(t,e,r))}class sh extends si{constructor(e){super(),this.firestore=e}convertBytes(e){return new iV(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iC(this.firestore,null,t)}}function sc(e){e=iE(e,iS);let t=iE(e.firestore,ik),r=iR(t),n=new sh(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
